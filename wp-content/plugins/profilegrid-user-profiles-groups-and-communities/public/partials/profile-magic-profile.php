...
if($dbhandler->get_global_option_value('pm_enable_private_profile')=='1')
{
    ...
    {
        echo $dbhandler->get_global_option_value('pm_private_profile_message',__('You are not authorized to view contents of this page.','profilegrid-user-profiles-groups-and-communities'));
        return false;
    }
